...
const techStack = [
  ...
  { name: "Cursor", abbr: "Cu", color: "#a78bfa" },
...
/* ------------------------------------------------------------------ */
/*  Card D — Infinite vertical scroll                                  */
/* ------------------------------------------------------------------ */
...
function InfiniteScroll() {
  ...
  return (
    <div className="relative flex-1 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-x-0 top-0 z-10 h-10 bg-gradient-to-b from-[#0f172a] to-transparent" />
      <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10 h-10 bg-gradient-to-t from-[#0f172a] to-transparent" />
      ...
      <motion.div
        ...
        className="flex flex-col gap-2.5 px-3"
      >
        {doubled.map((tech, i) => (
          <div
            key={i}
            className="flex items-center gap-3 rounded-lg border border-slate-800/60 bg-slate-900/60 px-3 py-2.5"
          >
            <div
    ...
    <section className="relative bg-[#020617] px-4 py-24">
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          {/* ======================================================= */}
          {/*  Card D — The Toolbelt  (1 col × 1 row, infinite scroll)*/}
          {/* ======================================================= */}
          <WorkCard
            href="#toolbelt"
            glowColor="rgba(167,139,250,0.06)"
            className="min-h-[300px] pb-0 md:min-h-0"
          >
            <div data-glow className="absolute inset-0" />
